...
<div class="container mx-auto px-6 lg:px-12 py-32 text-center">
    ...
    <a href="/pj2/public/" class="inline-block bg-lumina-navy text-white px-8 py-3 font-medium uppercase tracking-wider text-sm hover:bg-opacity-90 transition">Return Home</a>
</div>
